...
#
# Created: Sun Jul  5 21:56:48 2020
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.widAlign = QtGui.QWidget(self.centralwidget)
        self.widAlign.setEnabled(True)
        self.widAlign.setGeometry(QtCore.QRect(880, 0, 1051, 1021))
        ...
        self.label_3 = QtGui.QLabel(self.widAlign)
        self.label_3.setGeometry(QtCore.QRect(90, 40, 251, 21))
        self.label_3.setObjectName("label_3")
        self.sequenceInput2 = QtGui.QPlainTextEdit(self.widAlign)
        self.sequenceInput2.setGeometry(QtCore.QRect(70, 460, 910, 311))
        self.sequenceInput2.setObjectName("sequenceInput2")
        self.sequenceInput1 = QtGui.QPlainTextEdit(self.widAlign)
        self.sequenceInput1.setGeometry(QtCore.QRect(70, 90, 910, 311))
        self.sequenceInput1.setObjectName("sequenceInput1")
        self.widCompare = QtGui.QWidget(self.centralwidget)
        self.widCompare.setEnabled(True)
        self.widCompare.setGeometry(QtCore.QRect(880, 30, 1051, 961))
        ...
        self.buttonMenuEdit.setGeometry(QtCore.QRect(380, 430, 401, 45))
        self.buttonMenuEdit.setObjectName("buttonMenuEdit")
        self.buttonMenuCompare = QtGui.QPushButton(self.widMainMenu)
        self.buttonMenuCompare.setGeometry(QtCore.QRect(380, 270, 401, 45))
        self.buttonMenuCompare.setObjectName("buttonMenuCompare")
        self.buttonMenuDelete = QtGui.QToolButton(self.widMainMenu)
        self.buttonMenuDelete.setGeometry(QtCore.QRect(380, 510, 401, 45))
        self.buttonMenuDelete.setObjectName("buttonMenuDelete")
        self.buttonMenuAdd = QtGui.QToolButton(self.widMainMenu)
        self.buttonMenuAdd.setGeometry(QtCore.QRect(380, 350, 401, 45))
        self.buttonMenuAdd.setObjectName("buttonMenuAdd")
        self.buttonMenuAlign = QtGui.QPushButton(self.widMainMenu)
        self.buttonMenuAlign.setGeometry(QtCore.QRect(380, 590, 401, 45))
        self.buttonMenuAlign.setObjectName("buttonMenuAlign")
        mainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(mainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2188, 18))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.buttonDeleteSeq.setText(QtGui.QApplication.translate("mainWindow", "Eliminar secuencia", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.buttonMenuCompare.setText(QtGui.QApplication.translate("mainWindow", "Comparar secuencia con una base de datos", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.buttonMenuAlign.setText(QtGui.QApplication.translate("mainWindow", "Alinear dos secuencias", None, QtGui.QApplication.UnicodeUTF8))
