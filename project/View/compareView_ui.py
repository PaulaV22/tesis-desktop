...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.buttonMenuCompare.setText(QtGui.QApplication.translate("mainWindow", "Encontrar alelos en una base de datos", None, QtGui.QApplication.UnicodeUTF8))
